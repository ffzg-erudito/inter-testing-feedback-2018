...
\StringTok{  }\KeywordTok{mvn}\NormalTok{(., }\DataTypeTok{multivariatePlot =} \StringTok{'qq'}\NormalTok{, }\DataTypeTok{mvnTest =} \StringTok{'hz'}\NormalTok{, }\DataTypeTok{desc =}\NormalTok{ T)}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{by}\NormalTok{(datHardNofeed}\OperatorTok{$}\NormalTok{totalIntrusors, }\DataTypeTok{INDICES =}\NormalTok{ datHardNofeed}\OperatorTok{$}\NormalTok{activityFactor,}
   \DataTypeTok{FUN =}\NormalTok{ shapiro.test)}
\end{Highlighting}
\end{Shaded}
