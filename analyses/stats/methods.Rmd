...
(feedback: given vs not given) between-subjects design. An
additional group which engaged in rereading was used as a control.
In total, this amounts to five separate groups, which the participants were randomly
assigned to.
...
were translated, and some plants were removed from the text to make it less
difficult for the target participant population. The text was divided into three
interrelated parts (874, 754, and 835 words) constituting an integrated body of
knowledge. Additionally, a practice text (768 words), not directly related to any of the
other three parts, was taken from the same chapter.
The materials were presented on a PC, in an application
...
content-related testing conditions.
