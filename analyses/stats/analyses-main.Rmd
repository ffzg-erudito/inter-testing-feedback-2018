...
`BayesFactor` package's default priors. The estimated posterior mean of the difference in
...
certain caveats. The `BayesFactor` package's default priors were used.
...
Analyses conducted using the `R` language \citep{rcoreteamLanguageEnvironmentStatistical2019}.
...
Highest density intervals obtained using `HDInterval` \citep{meredithHDIntervalHighestPosterior2018}.