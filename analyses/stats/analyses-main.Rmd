...
between small and medium (Cohen's \(f^2\ \gtrsim 0.6\)), with an \(\alpha\) level
of .025. Note that larger effects are expected based on prior studies.
...
between small and medium (Cohen's \(f^2\ \gtrsim 0.5\)), with an \(\alpha\)
level of .025.
