...
This result points to a positive effect of content related testing on learning,
compared to general knowledge testing.
...
cohensF2w <- nrow(datHardFeed) - 0 - (2 + 1 + 3) * .5

cohensF2v <- cohensF2w * cohensF2r + 1 - cohensF2u / 2

cohensF2 <- manovaStats(manovaModelInter, 'test',
                        '^activityFactor\\b ',
                        test = 'Wilks')^(-1 / cohensF2r) *
                          (cohensF2v / (cohensF2v + cohensF2u)) - 1
```
