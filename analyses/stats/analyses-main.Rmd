...
options(digits = 5, scipen = 7, knitr.kable.NA = '')
...
manovaStats(manovaModelInter, 'test', '^activityFactor:', test = 'Wilks'),
manovaStats(manovaModelInter, 'df', '^activityFactor:', test = 'Wilks'))`
(bootstrap (R = 10000) median = `r bootOutInt$t %>% median(.)`, \(BC_\alpha\) 95% CI =
[`r ciOutInt$bca[4]`, `r ciOutInt$bca[5]`]). Both the feedback and the interaction
