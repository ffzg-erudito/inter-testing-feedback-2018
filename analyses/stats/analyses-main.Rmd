...
- nisu problemi
    - generalizacija na situacije u kojima učenici trebaju savladati gradivo koje
      im je većinom nepoznato
    - nemamo konkretan razlog za vjerovati da bi sadržaj materijala imao ikakvog relevantnog
      efekta, odnosno da se efekt ne bi javio s drugim sadržajem
