...
\begin{figure*}
\input{linear-discriminant-analysis_files/figure-latex/ldaPlot-1.tex}\caption[\label{ldaPlot1}Plot showing the cases' location on the two variates]{\label{ldaPlot1}Plot showing the cases' location on the two variates. Group means on the variates are marked by crosses. The vertical line marks the 0 on the first variate.}\label{fig:ldaPlot}
\end{figure*}
