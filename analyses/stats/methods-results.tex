...
third text, all participants were presented with twenty questions
...
\begin{tabular}{lrrrl}
\toprule
\multicolumn{1}{r}{Term} & \multicolumn{1}{r}{$SS$} & \multicolumn{1}{r}{$df$} & \multicolumn{1}{r}{$F$} & \multicolumn{1}{r}{$p$}\\
\midrule
\addlinespace[0.3em]
\multicolumn{5}{l}{\textbf{ANOVA}}\\
\hspace{1em}Activity & 109.393 & 1 & 11.200 & \multicolumn{1}{r}{.001}\\
\hspace{1em}Feedback & 3.904 & 1 & 0.400 & \multicolumn{1}{r}{.528}\\
\hspace{1em}Activity x Feedback & 0.045 & 1 & 0.005 & \multicolumn{1}{r}{.946}\\
\hspace{1em}Residuals & 1553.046 & 159 &  & \multicolumn{1}{r}{}\\
\addlinespace[0.3em]
\multicolumn{5}{l}{\textbf{ANCOVA}}\\
\hspace{1em}Activity & 0.301 & 1 & 0.175 & \multicolumn{1}{r}{.676}\\
\hspace{1em}Feedback & 0.173 & 1 & 0.100 & \multicolumn{1}{r}{.752}\\
\hspace{1em}Total correct & 63.216 & 1 & 36.760 & \multicolumn{1}{r}{< .0001}\\
\hspace{1em}Activity x Feedback & 0.813 & 1 & 0.473 & \multicolumn{1}{r}{.493}\\
\hspace{1em}Activity x Total correct & 0.862 & 1 & 0.501 & \multicolumn{1}{r}{.480}\\
\hspace{1em}Feedback x Total correct & 0.130 & 1 & 0.075 & \multicolumn{1}{r}{.784}\\
\hspace{1em}Activity x Feedback x Total correct & 1.229 & 1 & 0.715 & \multicolumn{1}{r}{.399}\\
\hspace{1em}Residuals & 266.551 & 155 &  & \multicolumn{1}{r}{}\\
\bottomrule
\end{tabular}
\end{table*}
