...
twenty novel questions examining their knowledge of that part. We have
decided to increase the number of questions for the final test because
we wanted to avoid a ceiling effect on our main dependent variable,
which could mask a real effect of test potentiated new learning. No
...
The computer recorded whether a participant correctly answered a
question and whether the participant chose an intrusive distractor. This
allowed us to compute our dependent variables --- the total number of
correct answers and the total number of intrusive distractors chosen.
