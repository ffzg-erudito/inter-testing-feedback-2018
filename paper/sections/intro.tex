...
\begin{enumerate}[label = \textit{H\arabic*}:]
    \itemsep0pt
    \item Compared to the rereading group, participants in the retrieval groups
    ...
    \item We expect to find an interaction effect between feedback
    ...
    \item Finally, we expect to find an interaction effect of activity type and
