...
Participants in the content-related-test condition score higher on the final
test than those in the general-knowledge-test condition. The second
...
}. On the other hand, we found no evidence for an effect of feedback
...
(\(F(1, 155) = 0.175, p = .676\)). Therefore, we find neither evidence for an
effect of interpolated activity type nor for a feedback effect on the
