...
fall between small and medium (Cohen's \(f^2\ \gtrsim 0.6\)), with an
\(\alpha\) level of .025. Note that larger effects are expected based on
prior studies.
...
has shown that we should have above 80\% power to detect effects which
fall between small and medium (Cohen's \(f^2\ \gtrsim 0.5\)), with an
\(\alpha\) level of .025.
