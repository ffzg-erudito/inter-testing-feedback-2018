...
(feedback: given vs not given) between-subjects design. An additional
group which engaged in rereading was used as a control. In total, this
amounts to five separate groups, which the participants were randomly
assigned to.
