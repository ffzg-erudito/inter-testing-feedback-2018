...
(semantic retrieval), or (iii) reread the previous part. Approximately half of
the participants in the two retrieval conditions were assigned to receive
...
capturing proactive interference.
Planned analyses showed that participants in
...
rejected, which is reflected in exploratory Bayesian analyses. Results are 
interpreted in terms of integration and metacognitive frameworks suggested
