...
class instructions_1(Page):
    ...
    def vars_for_template(self):
        # if
        question_message = "Vaš sljedeći zadatak je odgovoriti na nekoliko pitanja vezanih za sadržaj pročitanog teksta."
        return {
...
page_sequence = [timer_instructions_0, practice_text, instructions_1, Question, instructions_2, Results, get_ready]
